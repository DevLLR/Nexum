const informacion = [
    ...
    {
        titulo : `<h3 class="tituloExpand">Remates</h3>`,
        texto : `<p class="textoExpand">Para llegar a esta instancia se requiere el haber recorrido un largo camino en la tramitación del juicio. Sin embargo la ley otorga medios para evitarlos y poder negociar una solución que no implique la ejecución de su bien.<br>La subasta de una propiedad debe ser notificada previamente y un oficial de justicia debera visitarlo y constatar su estado. Es importante no demorarse en consultar al abogado ante esta situacion ya que existen plazos para cuestionar las actuaciones judiciales realizadas.<br>Incluso habiendo sido rematado su bien aun existen posibilidades de buscar una solución.</p>`
    },
    {
